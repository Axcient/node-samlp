  ...
  describe("HTTP Redirect", function () {
    ...
    describe("SP initiated - 2 Session Participants", function () {
      ...
      it("should validate LogoutRequest to Session Participant", function () {
        ...
        expect(
          xmlhelper.getIssueInstantUTC(sessionParticipantLogoutRequest)
        ).to.equal(frozenTime);
        expect(
          xmlhelper.getDestination(sessionParticipantLogoutRequest)
        ).to.equal(sessionParticipant2.serviceProviderLogoutURL);
        expect(xmlhelper.getConsent(sessionParticipantLogoutRequest)).to.equal(
          "urn:oasis:names:tc:SAML:2.0:consent:unspecified"
        );
        expect(
          xmlhelper.getElementText(sessionParticipantLogoutRequest, "Issuer")
        ).to.equal(samlIdPIssuer);
        expect(
          xmlhelper.getElementText(sessionParticipantLogoutRequest, "NameID")
        ).to.equal(sessionParticipant2.nameId);
        expect(
          xmlhelper.getElementText(
            sessionParticipantLogoutRequest,
            "samlp:SessionIndex"
          )
        ).to.equal(sessionParticipant2.sessionIndex);
      });
      ...
      it("should validate LogoutRequest signature", function () {
        ...
        expect(
          utils.validateSignature(
            ...
            "LOGOUT_REQUEST",
            sessionParticipantLogoutRequest,
            { signingCert: server.credentials.cert.toString(), deflate: true }
          )
        ).to.be.undefined;
      });
      ...
      describe("should send Session Participant LogoutResponse to the SAML IdP", function () {
        ...
        it("should validate LogoutResponse to the Session Participant that initiated the logout", function () {
          ...
          expect(
            xmlhelper.getIssueInstantUTC(sessionParticipantLogoutResponse)
          ).to.equal(frozenTime);
          expect(
            xmlhelper.getDestination(sessionParticipantLogoutResponse)
          ).to.equal(sessionParticipant1.serviceProviderLogoutURL);
          expect(
            xmlhelper.getInResponseTo(sessionParticipantLogoutResponse)
          ).to.equal("samlr-220c705e-c15e-11e6-98a4-ecf4bbce4318");
          expect(
    ...
    describe("SP initiated - Invalid signature", function () {
      ...
      it("should return invalid signture error", function () {
        ...
        expect(response.body).to.equal(
          "Signature check errors: The signature provided (asidjpasjdpasjndoubvuojewprjweprj) does not match the one calculated"
        );
      });
    });
    ...
    describe("IdP initiated - 1 Session Participant", function () {
      ...
      it("should validate LogoutRequest to Session Participant", function () {
        ...
        expect(
          xmlhelper.getElementText(sessionParticipantLogoutRequest, "NameID")
        ).to.equal(sessionParticipant1.nameId);
        expect(
          xmlhelper.getElementText(
            sessionParticipantLogoutRequest,
            "samlp:SessionIndex"
          )
        ).to.equal(sessionParticipant1.sessionIndex);
      });
    ...
    describe("IdP initiated - 2 Session Participant", function () {
      ...
      it("should validate LogoutRequest to Session Participant", function () {
        ...
        expect(
          xmlhelper.getNameIdentifierFormat(sessionParticipantLogoutRequest)
        ).to.equal(sessionParticipant1.nameIdFormat);
        expect(
          xmlhelper.getElementText(
            sessionParticipantLogoutRequest,
            "samlp:SessionIndex"
      ...
      describe("should send Session Participant 1 LogoutResponse to the SAML IdP", function () {
        ...
        before(function (done) {
          ...
          request.get(
            ...
            function (err, response) {
              ...
              sessionParticipant2LogoutRequestRelayState =
                parsedQueryString.RelayState;
        ...
        it("should validate LogoutRequest to Session Participant 2", function () {
          ...
          expect(
            xmlhelper.getIssueInstantUTC(sessionParticipant2LogoutRequest)
          ).to.equal(frozenTime);
          expect(
            xmlhelper.getDestination(sessionParticipant2LogoutRequest)
          ).to.equal(sessionParticipant2.serviceProviderLogoutURL);
          expect(
            xmlhelper.getConsent(sessionParticipant2LogoutRequest)
          ).to.equal("urn:oasis:names:tc:SAML:2.0:consent:unspecified");
          expect(
            xmlhelper.getElementText(sessionParticipant2LogoutRequest, "Issuer")
          ).to.equal(samlIdPIssuer);
          expect(
            xmlhelper.getElementText(sessionParticipant2LogoutRequest, "NameID")
          ).to.equal(sessionParticipant2.nameId);
          expect(
            xmlhelper.getElementText(
              sessionParticipant2LogoutRequest,
              "samlp:SessionIndex"
            )
          ).to.equal(sessionParticipant2.sessionIndex);
        });
  ...
  describe("HTTP POST", function () {
    ...
    describe("SP initiated - 2 Session Participants", function () {
      ...
      it("should validate LogoutRequest to Session Participant", function () {
        ...
        expect(
          xmlhelper.getNameIdentifierFormat(sessionParticipantLogoutRequest)
        ).to.equal(sessionParticipant2.nameIdFormat);
        expect(
          xmlhelper.getElementText(
            sessionParticipantLogoutRequest,
            "samlp:SessionIndex"
      ...
      it("should validate LogoutRequest signature", function () {
        ...
        expect(
          utils.validateSignature(
            ...
            "LOGOUT_REQUEST",
            doc,
            { signingCert: server.credentials.cert }
          )
        ).to.be.undefined;
      });
      ...
      describe("should send Session Participant 2 LogoutResponse to the SAML IdP", function () {
        ...
        it("should validate LogoutResponse to the Session Participant that initiated the logout", function () {
          ...
          expect(
            xmlhelper.getInResponseTo(sessionParticipantLogoutResponse)
          ).to.equal("pfx6fe657e3-1a7f-893e-f690-f7fc5162ea11");
          expect(
            xmlhelper.getIssuer(sessionParticipantLogoutResponse)
          ).to.equal(samlIdPIssuer);
        });
          ...
          request.post(
            {
              ...
              body: {
                SAMLResponse:
                  "",
    ...
    describe("SP initiated - Invalid signature", function () {
      ...
      it("should return invalid signature error", function () {
        ...
        expect(response.body).to.equal(
          "Signature check errors: invalid signature: the signature value asidjpasjdpasjndoubvuojewprjweprj is incorrect"
        );
      });
    });
