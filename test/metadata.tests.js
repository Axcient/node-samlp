...
describe("samlp metadata", function () {
  ...
  describe("request to metadata", function () {
    ...
    it("should have the redirect endpoint url", function () {
      expect(
        doc
          .getElementsByTagName("SingleSignOnService")[0]
    ...
    it("should have the POST endpoint url", function () {
      expect(
        doc
          .getElementsByTagName("SingleSignOnService")[1]
          .getAttribute("Binding")
    ...
    it("should have the claim types", function () {
      expect(doc.getElementsByTagName("Attribute")).to.not.be.empty;
    });

    it("should have the issuer", function () {
      expect(doc.getAttribute("entityID")).to.equal("urn:fixture-test");
    });

    it("should have the pem", function () {
      expect(
        doc.getElementsByTagName("X509Certificate")[0].textContent
